...
poolroot <- "alt_ETH_anc_12SH_12"    #pool you want to get haps for

outdir <- "~/Dropbox/Ethanol expression project/Genomic_analysis/Haplotypes/Ancestor"
...
for(i in 1:length(chr)){
  ...
  runscan(inputfilename, as.character(chr[i]), poolroot, founderfile, outdir)
}
